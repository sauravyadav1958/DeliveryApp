...
public class SecurityController {
  ...
  public String resetPasswordLink(@RequestBody ResetPasswordRequest resetPasswordRequest) {
    ...
    String resetPasswordResult = passwordService.resetPasswordLink(resetPasswordRequest.getEmailId());
    return resetPasswordResult;

  }

  @PostMapping("/confirmResetPasswordLink")
  public String confirmResetPasswordLink(@RequestParam String token, @RequestBody ResetPasswordRequest resetPasswordRequest) {

    String resetPasswordResult = passwordService.confirmResetPasswordLink(token, resetPasswordRequest);
    return resetPasswordResult;
